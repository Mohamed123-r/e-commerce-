...
final class ResendOTPSuccess extends ForgetPasswordState {
  final String message;

  ResendOTPSuccess(this.message);
}

final class ResendOTPLoading extends ForgetPasswordState {}

final class ResendOTPFailure extends ForgetPasswordState {
  final String message;
