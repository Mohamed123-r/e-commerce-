...
class VerificationCodeSignUpScreen extends StatefulWidget {
  const VerificationCodeSignUpScreen({super.key, required this.email});

  static const String routeName = '/verification-code-from-sign-up';

  final String email;

  @override
  State<VerificationCodeSignUpScreen> createState() =>
      _VerificationCodeSignUpScreenState();
}

class _VerificationCodeSignUpScreenState
    extends State<VerificationCodeSignUpScreen> {
